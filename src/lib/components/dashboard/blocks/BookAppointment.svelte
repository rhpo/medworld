<script lang="ts">
  ...
  let filteredDoctors = $derived(
    (() => {
      const allDoctors = selectedCabinet
        ? selectedCabinet.doctors
        : cabinets.flatMap((c) => c.doctors);
  ...
  <div class="booking-container">
    <div class="progress-bar">
      <div class="progress-step" class:active={step >= 1}>
        ...
        <span>Select {searchType === "cabinet" ? "Cabinet" : "Doctor"}</span>
      </div>
      <div class="progress-line" class:active={step >= 2} />
      <div class="progress-step" class:active={step >= 2}>
        <div class="step-number">2</div>
        <span
          >{searchType === "cabinet" ? "Select Doctor" : "Select Cabinet"}</span
        >
      </div>
      <div class="progress-line" class:active={step >= 3} />
          ...
          <div class="selection-summary">
            ...
            <div class="summary-item">
              ...
              <div>
                ...
                <span class="specialty">{selectedDoctor?.speciality}</span>
              </div>
            </div>
          </div>
    ...
    <div class="actions">
      {#if step > 1}
        <Button category="secondary" label="Back" onClick={handleBack} />
      {/if}
      ...
      {#if step < 3}
        <Button
          category="primary"
          label="Next"
          disabled={(step === 1 && !selectedCabinet && !selectedDoctor) ||
