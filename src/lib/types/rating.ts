...
export function calculateRatingScore(
  ...
  for (const rating of cabinet.ratings) {
    ...
    // User Experience
    ratingScore +=
      rating.userExperience.reception * weights.userExperienceWeights.reception;
    ratingWeight += weights.userExperienceWeights.reception;
    ratingScore +=
      rating.userExperience.hygiene * weights.userExperienceWeights.hygiene;
    ratingWeight += weights.userExperienceWeights.hygiene;
    ratingScore +=
      rating.userExperience.waitTime * weights.userExperienceWeights.waitTime;
    ratingWeight += weights.userExperienceWeights.waitTime;
    ratingScore +=
      rating.userExperience.communication *
      weights.userExperienceWeights.communication;
    ratingWeight += weights.userExperienceWeights.communication;
    ratingScore +=
      rating.userExperience.professionalism *
      weights.userExperienceWeights.professionalism;
    ratingWeight += weights.userExperienceWeights.professionalism;
    ratingScore +=
      rating.userExperience.emplacement *
      weights.userExperienceWeights.emplacement;
