        ...
        <Section title="Opening Hours">
          <div class="hours-list">
            {#each weekDays as day}
              <div
                class="hours-item"
                class:closed={!cabinet.openingHours?.[day.toLowerCase()]}
              >
                <div class="day">{day}</div>
                <div class="time">
                  {#if cabinet.openingHours?.[day.toLowerCase()]}
                    {formatTime(cabinet.openingHours[day.toLowerCase()].open)} -
                    {formatTime(cabinet.openingHours[day.toLowerCase()].close)}
                  {:else}
                    <i>Closed</i>
                  {/if}
                </div>
          ...
          <div class="settings-list">
            <div class="settings-item">
              ...
              <div class="settings-info">
                <div class="settings-label">Average Consultation Duration</div>
                <div class="settings-value">
                  {(cabinet.doctors.reduce(
                    ...
                    0
                  ) as any as number) / cabinet.doctors.length} minutes
                </div>
              </div>
            </div>
            <div class="settings-item">
